...
class carousel(models.Model):
    carousel_pic = models.ImageField(upload_to = 'mainapp/static/mainapp/image', default = 'mainapp/image/no_img.jpg')
...
class event(models.Model):
    ...
    """
    event_pic = models.ImageField(upload_to = 'mainapp/static/mainapp/image', default = 'mainapp/image/no_img.jpg')
